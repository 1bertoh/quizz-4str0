      ...
      isLoading ? (
        <ResultScreen>
          <h2 className="text-zinc-600">
            Estamos calculando o resultado do seu QUIZZ!!
          </h2>
          <span className="!animate-spin">oi</span>
        </ResultScreen>
      ) : (
      <ResultScreen>
            <div className="text-zinc-600">
              <h2 className="text-3xl">Parabéns! Você completou o quiz! 🎉</h2>
              <p>
                Descubra o segredo das celebridades para emagrecer rápido e ganhar
                músculos com o nosso ebook exclusivo!
              </p>
              <br />
              <p className="font-bold bg-green-600">60 Receitas Proteicas: Aumente Sua Energia e Ganhe Músculos!</p>
              <CTAButton
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                onClick={() => alert("Redirecionar para a página de compra")}
              >
                Quero meu ebook agora!
              </CTAButton>
            </div>
